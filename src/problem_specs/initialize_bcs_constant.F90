...
#include "lbm_definitions.h"    
    ...
    case (2) 
      call initialize_bcs_d2(bc_flags, xm_bcvals, xp_bcvals, ym_bcvals, & 
       yp_bcvals, zm_bcvals, zp_bcvals, bc_dim, dist, options)
    case (3) 
      call initialize_bcs_d3(bc_flags, xm_bcvals, xp_bcvals, ym_bcvals, & 
       yp_bcvals, zm_bcvals, zp_bcvals, bc_dim, dist, options)
    end select
...
! --- zm boundary
    ...
    return
  end subroutine initialize_bcs_d3
...
! --- ym boundary
    ...
    return
  end subroutine initialize_bcs_d2
